...
export default function Home() {
  ...
  const [isModalOpen, setIsModalOpen] = useState(false); // Modal state eklendi
  ...
  const handleAction = async () => {
    ...
    // Cüzdan bağlı değilse modalı aç, bağlıysa işleme devam et
    if (!walletAddress) {
      setIsModalOpen(true);
      return;
    }
